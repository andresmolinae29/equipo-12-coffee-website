...
VALUES
    ...
    ('Costa Rica Rivense H17 Natural','Fresa deshidratada, azúcar moreno, pomelo','6oz',29.0,'single origin','img-costa-origin.jpg','Café naturalmente este lote permitiendo que las cualidades genéticas brillen en su perfil de sabor',0,'limit-offer'),
    ('Costa Rica La Lia Gesha Ethiopia Black Honey','Compota de cereza, rosa, ciruela','6oz',27.0,'single origin','img-lalia-espresso.jpg','Este café tiene una profundidad de complejidad, en parte debido a su procesamiento intrincado e inusual, pero también por los destellos de Gesha mezclados en el lote. Por sí solo, Gesha exuda aromas florales; mezclado con variedades tradicionales de Etiopía, como se ve aquí, el aroma se respira como un ramo completo terminado con rosas. Para el gusto, una mermelada dulce tiene capas de cítricos y frutas de hueso, bien equilibradas y brillantes.',0,'limit-offer'),
